...
# MCU + SDK
mcu_plus_sdk_url="${MCU_PLUS_SDK_AM263PX_RELEASE_URL}"
mcu_sdk_version="${MCU_PLUS_SDK_AM263PX}"

# IND COMMS SDK
ind_comms_sdk_url="${IND_COMMS_SDK_AM263PX_NIGHTLY_URL}"
ind_comms_sdk_version="${IND_COMMS_SDK_AM263PX}"
